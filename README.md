...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://rodik-stackbit.ngrok.io/pull/5feb1abe396f01488400b7b0
...
To start editing your site, you can use the Sanity interface at https://maroon-chili-b1abe.sanity.studio/.
...
Generated at `2020-12-29T12:02:25.828Z` by Stackbit version `0.3.42`.